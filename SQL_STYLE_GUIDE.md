...
The Spark SQL implementation of **fabricfmt** is a custom Grammar based formatter.  Meanign the formatter understands the SQL, and formats it in a way consistent with how you think about the code. This guide explains *what* the formatter does so you know what to expect.
...
**Leading commas** (comma-first style) make it easy to add, remove, or reorder columns without touching other lines:
